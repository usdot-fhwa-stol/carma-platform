...
/*
  ...
  */
 RCLCPP_ERROR_STREAM(rclcpp::get_logger("carma_wm::MapConformerTest"), "Create new map");
...
lanelet::Areas areas;
  ...
  RCLCPP_ERROR_STREAM(rclcpp::get_logger("carma_wm::MapConformerTest"),"There are "<<llts.size()<<" lanelets.");
...
std::vector<lanelet::Lanelet> llt2;
  ...
  RCLCPP_ERROR_STREAM(rclcpp::get_logger("carma_wm::MapConformerTest"), "Number of lanelets: "<< llt2.size());
