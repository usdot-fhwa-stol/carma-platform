...
namespace carma_guidance_plugin
{
  ...
  /**
   * \brief TacticalPlugin provides default functionality for all carma guidance plugins.
  ...
  private:
    // Services
    carma_ros2_utils::ServicePtr<carma_planning_msgs::msg::PlanTrajectory> plan_trajectory_service_;
  ...
  public:
    ...
    virtual void plan_trajectory_callback(
      ...
      carma_planning_msgs::srv::PlanTrajectory::Response &resp) = 0;
