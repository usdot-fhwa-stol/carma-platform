...
if [[ "$BRANCH" = "develop" ]]; then
      ...
      git clone --depth=1 https://github.com/usdot-fhwa-stol/carma-msgs.git --branch release/hudson
      git clone --depth=1 https://github.com/usdot-fhwa-stol/carma-utils.git --branch release/hudson
      git clone --depth=1 https://github.com/usdot-fhwa-stol/carma-messenger.git --branch release/hudson
      git clone --depth=1 https://github.com/usdot-fhwa-stol/autoware.auto.git --branch hotfix/higher_point_limit
fi
