...
{
	/**
    * \brief This class includes logic for Platoon control IHP. It includes publishers and subscribers and their callback functions
	*/
    class PlatoonControlIHPPlugin
    {
        public:
			...
			/**
			* \brief Default constructor for PlatoonControlPluginIHP class
			*/
