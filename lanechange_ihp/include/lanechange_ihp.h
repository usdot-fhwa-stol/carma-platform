    ...
    class LaneChangeIHPPlugin
    {
        public:
            ...
            */
            ...
            PointIndexPair find_closest_point_index_pair(lanelet::ConstLanelet lanelet_input,double dowtrack);//XX
             ...
             */
            lanelet::BasicLineString2d create_route_geom( double starting_downtrack, int starting_lane_id, double ending_downtrack, int ending_lane_id, const carma_wm::WorldModelConstPtr& wm);
             ...
             */
            lanelet::BasicLineString2d create_lanechange_path(PointIndexPair start, lanelet::ConstLanelet& start_lanelet, PointIndexPair end, lanelet::ConstLanelet& end_lanelet);
             ...
             */ 
            double compute_curvature_at(const lanechange_ihp::smoothing::SplineI& fit_curve, double step_along_the_curve) const;
            ...
            */
            ...
            ros::Publisher lanechange_ihp_plugin_discovery_pub_;
