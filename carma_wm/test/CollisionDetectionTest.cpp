...
namespace carma_wm
{
  ...
  TEST(CollisionDetectionTest, WorldCollisionDetection)
  {
    ...
    trajectory_point_2.target_time = ros::Time(1.0);

    trajectory_point_3.x = 1.0;
    trajectory_point_3.y = 3.0;
    trajectory_point_3.target_time = ros::Time(2.0);

    trajectory_point_4.x = 1.0;
    trajectory_point_4.y = 4.0;
    trajectory_point_4.target_time = ros::Time(3.0);

    trajectory_point_5.x = 1.0;
    trajectory_point_5.y = 5.0;
    trajectory_point_5.target_time = ros::Time(4.0);
  ...
  TEST(CollisionDetectionFalseTest, WorldCollisionDetection)
  {
    ...
    trajectory_point_2.x = 1.0;
    trajectory_point_2.y = 2.0;
    trajectory_point_2.target_time = ros::Time(0.001);

    trajectory_point_3.x = 1.0;
    trajectory_point_3.y = 3.0;
    trajectory_point_3.target_time = ros::Time(0.002);

    trajectory_point_4.x = 1.0;
    trajectory_point_4.y = 4.0;
    trajectory_point_4.target_time = ros::Time(0.003);

    trajectory_point_5.x = 1.0;
    trajectory_point_5.y = 5.0;
    trajectory_point_5.target_time = ros::Time(0.004);
