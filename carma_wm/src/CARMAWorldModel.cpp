...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    boost::posix_time::ptime CARMAWorldModel::min_end_time_converter_minute_of_year(boost::posix_time::ptime min_end_time,bool moy_exists)
    {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if(current_movement_state.movement_event_list.size()>1) // Dynamic Spat Processing with future phases
        {
          for(auto current_movement_event:current_movement_state.movement_event_list)
          {
            ...
            min_end_time_dynamic=min_end_time_converter_minute_of_year(min_end_time_dynamic,curr_intersection.moy_exists); // Accounting minute of the year
