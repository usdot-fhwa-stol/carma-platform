...
if [[ ! -z "$ROS1_PACKAGES$ROS2_PACKAGES" ]]; then
    ...
    colcon build --install-base /opt/carma/install --cmake-args -DCMAKE_BUILD_TYPE=Release --packages-skip dbw_mkz_msgs novatel_oem7_msgs tracetools tracetools_test
fi
