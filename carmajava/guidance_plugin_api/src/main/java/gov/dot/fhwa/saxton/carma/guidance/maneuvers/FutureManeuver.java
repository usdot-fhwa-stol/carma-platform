...
/**
 * Base class for a compound maneuver that exists in either the lateral or longitudinal dimension (see derived classes
 * FutureLateralManeuver and FutureLongitudinalManeuver).  A future maneuver is initially defined only in terms
 ...
 */
public abstract class FutureManeuver implements ISimpleManeuver {
    ...
    /**
     * Indicates if the constituent maneuvers have filled that dimension of the FutureManeuver's allocated space
     */
    ...
    public boolean executeTimeStep() throws IllegalStateException {
        ...
        if (currentLoc >= startDist_) {
            ...
            log_.debug("MVR", "Executing constituent maneuver " + executingIdx_ + " in FutureManeuver");
