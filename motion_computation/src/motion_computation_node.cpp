...
MotionComputationNode::MotionComputationNode(const rclcpp::NodeOptions &options)
    : carma_ros2_utils::CarmaLifecycleNode(options),
      motion_worker_(std::bind(&MotionComputationNode::publishObject, this, std_ph::_1),
  ...
  config_.prediction_process_noise_max = declare_parameter<double>(
...
MotionComputationNode::handle_on_configure(const rclcpp_lifecycle::State &) {
  ...
  get_parameter<bool>("enable_ctrv_for_small_vehicle_obj",
                      config_.enable_ctrv_for_small_vehicle_obj);
  get_parameter<bool>("enable_ctrv_for_large_vehicle_obj",
