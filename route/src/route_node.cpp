  ...
  rg_worker_(tf2_buffer_)
{
  ...
  // Declare parameters
  config_.max_crosstrack_error =
    declare_parameter<double>("max_crosstrack_error", config_.max_crosstrack_error);
  config_.destination_downtrack_range =
    declare_parameter<double>("destination_downtrack_range", config_.destination_downtrack_range);
  ...
  config_.route_file_path =
    declare_parameter<std::string>("route_file_path", config_.route_file_path);
}

rcl_interfaces::msg::SetParametersResult Route::parameter_update_callback(
  const std::vector<rclcpp::Parameter> & parameters)
{
  auto error = update_params<double>(
    {{"max_crosstrack_error", config_.max_crosstrack_error},
     ...
     {"route_spin_rate", config_.route_spin_rate}},
    parameters);
  auto error_2 = update_params<int>({{"cte_max_count", config_.cte_max_count}}, parameters);
  auto error_3 =
    update_params<std::string>({{"route_file_path", config_.route_file_path}}, parameters);
...
carma_ros2_utils::CallbackReturn Route::handle_on_configure(const rclcpp_lifecycle::State &)
{
  ...
  twist_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>(
    "current_velocity", 1, std::bind(&RouteGeneratorWorker::twistCb, &rg_worker_, std_ph::_1));
  geo_sub_ = create_subscription<std_msgs::msg::String>(
    "georeference", 1, std::bind(&RouteGeneratorWorker::georeferenceCb, &rg_worker_, std_ph::_1));
  ...
  route_event_pub_ = create_publisher<carma_planning_msgs::msg::RouteEvent>(
  ...
  get_available_route_srv_ = create_service<carma_planning_msgs::srv::GetAvailableRoutes>(
    "get_available_routes",
    std::bind(
      &RouteGeneratorWorker::getAvailableRouteCb, &rg_worker_, std_ph::_1, std_ph::_2, std_ph::_3));
  set_active_route_srv_ = create_service<carma_planning_msgs::srv::SetActiveRoute>(
    "set_active_route",
    std::bind(
      &RouteGeneratorWorker::setActiveRouteCb, &rg_worker_, std_ph::_1, std_ph::_2, std_ph::_3));
  abort_active_route_srv_ = create_service<carma_planning_msgs::srv::AbortActiveRoute>(
    "abort_active_route",
    std::bind(
      &RouteGeneratorWorker::abortActiveRouteCb, &rg_worker_, std_ph::_1, std_ph::_2, std_ph::_3));
