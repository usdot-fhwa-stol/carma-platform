...
## Version 4.13.1, released July 27th 2026

### Summary

This is a hotfix release for the cdasim-config repository only. During smoke testing before merging the master branch back into develop, two configuration updates were identified that were not included in the 4.13.0 release.
...
- Updated the sensor configuration JSON file to correct the sensor location.
- Added the Move Over Law platform vehicle route.
  * Pull Requests: [cdasim-config PR 63](https://github.com/usdot-fhwa-stol/cdasim-config/pull/63)
