...
static asn_TYPE_member_t asn_MBR_item_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ITIScodesAndText__Member__item, choice.itis),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ITIScodesAndText__Member__item, choice.text),
...
static asn_CHOICE_specifics_t asn_SPC_item_specs_3 = {
	sizeof(struct ITIScodesAndText__Member__item),
	offsetof(struct ITIScodesAndText__Member__item, _asn_ctx),
	offsetof(struct ITIScodesAndText__Member__item, present),
	sizeof(((struct ITIScodesAndText__Member__item *)0)->present),
