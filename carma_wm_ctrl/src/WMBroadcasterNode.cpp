  ...
  : carma_ros2_utils::CarmaLifecycleNode(options)
{
  ...
  config_.tcr_bbox_expansion_meters = declare_parameter<double>("tcr_bbox_expansion_meters", config_.tcr_bbox_expansion_meters);
...
carma_ros2_utils::CallbackReturn WMBroadcasterNode::handle_on_configure(const rclcpp_lifecycle::State &)
{
  ...
  get_parameter<double>("tcr_bbox_expansion_meters", config_.tcr_bbox_expansion_meters);
  ...
  get_parameter<std::string>("tcm_icon_path", config_.tcm_icon_path);
  get_parameter<double>("tcm_icon_scale", config_.tcm_icon_scale);
  ...
  wmb_->setTCRBoundBoxExpansionMeters(config_.tcr_bbox_expansion_meters);
  ...
  wmb_->setVisualizationInfo(config_.tcm_icon_path, config_.tcm_icon_scale);
