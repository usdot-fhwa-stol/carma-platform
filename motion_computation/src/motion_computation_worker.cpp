...
void MotionComputationWorker::predictionLogic(
    carma_perception_msgs::msg::ExternalObjectList::UniquePtr obj_list) {
...
void MotionComputationWorker::setDetectionInputFlags(bool enable_sensor_processing,
...
void MotionComputationWorker::setDetectionMotionModelFlags(bool enable_ctrv_for_unknown_obj,
...
void MotionComputationWorker::mobilityPathCallback(
  ...
  if (!map_projector_) {
    RCLCPP_ERROR(logger_->get_logger(),
...
void MotionComputationWorker::psmCallback(const carma_v2x_msgs::msg::PSM::UniquePtr msg) {
  ...
  carma_perception_msgs::msg::ExternalObject obj_msg;
  conversion::convert(*msg, obj_msg, map_frame_id_, prediction_period_, prediction_time_step_,
                      *map_projector_, ned_in_map_rotation_, node_clock_);
...
void MotionComputationWorker::bsmCallback(const carma_v2x_msgs::msg::BSM::UniquePtr msg) {
  ...
  carma_perception_msgs::msg::ExternalObject obj_msg;
  conversion::convert(*msg, obj_msg, map_frame_id_, prediction_period_, prediction_time_step_,
                      *map_projector_, ned_in_map_rotation_);
...
carma_perception_msgs::msg::ExternalObjectList MotionComputationWorker::synchronizeAndAppend(
  ...
  output_list.objects.insert(output_list.objects.begin(), base_objects.objects.begin(),
                             base_objects.objects.end());
  output_list.objects.insert(output_list.objects.end(), new_objects.objects.begin(),
                             new_objects.objects.end());
  return output_list;
}
