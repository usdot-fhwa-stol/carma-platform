...
int MockCANDriver::run()
{
  ...
  addPassthroughPubNoHeader<std_msgs::Bool>(bag_prefix_ + stability_ctrl_active_topic_, stability_ctrl_active_topic_,
                                            false, 10);
  addPassthroughPubNoHeader<std_msgs::Bool>(bag_prefix_ + stability_ctrl_enabled_topic_, stability_ctrl_enabled_topic_,
                                            false, 10);
  addPassthroughPubNoHeader<std_msgs::Float64>(bag_prefix_ + steering_wheel_angle_topic_, steering_wheel_angle_topic_,
                                               false, 10);
  addPassthroughPubNoHeader<std_msgs::Float64>(bag_prefix_ + throttle_position_topic_, throttle_position_topic_, false,
                                               10);
  addPassthroughPubNoHeader<std_msgs::Bool>(bag_prefix_ + traction_ctrl_active_topic_, traction_ctrl_active_topic_,
                                            false, 10);
  addPassthroughPubNoHeader<std_msgs::Bool>(bag_prefix_ + traction_ctrl_enabled_topic_, traction_ctrl_enabled_topic_,
                                            false, 10);
  ...
  addPassthroughPubNoHeader<cav_msgs::TurnSignal>(bag_prefix_ + turn_signal_state_topic_, turn_signal_state_topic_,
                                                  false, 10);

  addPassthroughPub<geometry_msgs::TwistStamped>(bag_prefix_ + vehicle_twist, vehicle_twist, false, 10);
  addPassthroughPub<autoware_msgs::VehicleStatus>(bag_prefix_ + vehicle_status_topic_, vehicle_status_topic_, false,
                                                  10);
  addPassthroughPub<automotive_platform_msgs::VelocityAccel>(bag_prefix_ + velocity_accel_topic_, velocity_accel_topic_,
                                                             false, 10);
