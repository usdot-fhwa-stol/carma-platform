...
// TEST(LCITacticalPluginTest, determine_speed_profile_casetest)
// {
...
//   auto case_num1 = lci.determine_speed_profile_case(10, 12, 9, 8);

//   EXPECT_EQ(3, case_num1);

//   auto case_num2 = lci.determine_speed_profile_case(10, 12, 12, 1);

//   EXPECT_EQ(4, case_num2);

//   auto case_num3 = lci.determine_speed_profile_case(10, 9, 1, 2);

//   EXPECT_EQ(2, case_num3);

//   auto case_num4 = lci.determine_speed_profile_case(10, 9, 11, 1.4);
...
//   ROS_DEBUG_STREAM("\n Estimated time: " << lci.calc_estimated_entry_time_left(remaining_dist, starting_speed, departure_speed ) 
//                                          << ", scheduled time: " << remaining_time);
  
//   double speed_before_decel = lci.calc_speed_before_decel(remaining_time, remaining_dist, starting_speed, departure_speed);
...
//   ROS_DEBUG_STREAM("\n Estimated time: " << lci.calc_estimated_entry_time_left(remaining_dist, starting_speed, departure_speed ) 
//                                          << ", scheduled time: " << remaining_time);
//   speed_before_decel = lci.calc_speed_before_decel(remaining_time, remaining_dist, starting_speed, departure_speed);
...
//   double speed_before_accel = lci.calc_speed_before_accel(remaining_time, remaining_dist, starting_speed, departure_speed);
...
//   ROS_DEBUG_STREAM("\n Estimated time: " << lci.calc_estimated_entry_time_left(remaining_dist, starting_speed, departure_speed ) 
//                                          << ", scheduled time: " << remaining_time);
//   speed_before_accel = lci.calc_speed_before_accel(remaining_time, remaining_dist, starting_speed, departure_speed);
