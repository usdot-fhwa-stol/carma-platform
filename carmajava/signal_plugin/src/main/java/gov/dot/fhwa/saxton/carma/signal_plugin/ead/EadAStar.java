...
public class EadAStar implements IEad {
    ...
    public EadAStar() {
        ...
        speedLimit_ = (double)config.getMaximumSpeed() / Constants.MPS_TO_MPH;
        ...
        fuelCostModel_ = new FuelCostModel(vehicleMass_, rollingRes_, dragCoef_, frontalArea_, airDensity_,
