...
: carma_ros2_utils::CarmaLifecycleNode(options)
{
  ...
  // Declare parameters
  config_.bsm_generation_frequency =
    declare_parameter<double>("bsm_generation_frequency", config_.bsm_generation_frequency);
  config_.bsm_id_change_period =
    declare_parameter<double>("bsm_id_change_period", config_.bsm_id_change_period);
  config_.bsm_id_rotation_enabled =
    declare_parameter<bool>("bsm_id_rotation_enabled", config_.bsm_id_rotation_enabled);
...
rcl_interfaces::msg::SetParametersResult BSMGenerator::parameter_update_callback(
  const std::vector<rclcpp::Parameter> & parameters)
{
  auto error =
    update_params<bool>({{"bsm_id_rotation_enabled", config_.bsm_id_rotation_enabled}}, parameters);
...
carma_ros2_utils::CallbackReturn BSMGenerator::handle_on_configure(const rclcpp_lifecycle::State &)
{
  ...
  add_on_set_parameters_callback(
    std::bind(&BSMGenerator::parameter_update_callback, this, std_ph::_1));

  // Setup subscribers
  pose_sub_ = create_subscription<geometry_msgs::msg::PoseStamped>(
    "pose", 1, std::bind(&BSMGenerator::poseCallback, this, std_ph::_1));
  accel_sub_ = create_subscription<automotive_platform_msgs::msg::VelocityAccelCov>(
    "velocity_accel_cov", 1, std::bind(&BSMGenerator::accelCallback, this, std_ph::_1));
  yaw_sub_ = create_subscription<sensor_msgs::msg::Imu>(
    "imu_raw", 1, std::bind(&BSMGenerator::yawCallback, this, std_ph::_1));
  gear_sub_ = create_subscription<j2735_v2x_msgs::msg::TransmissionState>(
    "transmission_state", 1, std::bind(&BSMGenerator::gearCallback, this, std_ph::_1));
  speed_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>(
    "ekf_twist", 1, std::bind(&BSMGenerator::speedCallback, this, std_ph::_1));
  steer_wheel_angle_sub_ = create_subscription<std_msgs::msg::Float64>(
    "steering_wheel_angle", 1, std::bind(&BSMGenerator::steerWheelAngleCallback, this, std_ph::_1));
  brake_sub_ = create_subscription<std_msgs::msg::Float64>(
    "brake_position", 1, std::bind(&BSMGenerator::brakeCallback, this, std_ph::_1));
  heading_sub_ = create_subscription<gps_msgs::msg::GPSFix>(
    "gnss_fix_fused", 1, std::bind(&BSMGenerator::headingCallback, this, std_ph::_1));
  georeference_sub_ = create_subscription<std_msgs::msg::String>(
    "georeference", 1, std::bind(&BSMGenerator::georeferenceCallback, this, std_ph::_1));
...
carma_ros2_utils::CallbackReturn BSMGenerator::handle_on_activate(
  const rclcpp_lifecycle::State & prev_state)
{
  // Timer setup for generating a BSM
  int bsm_generation_period_ms =
    (1 / config_.bsm_generation_frequency) *
    1000;  // Conversion from frequency (Hz) to milliseconds time period
  timer_ = create_timer(
    get_clock(), std::chrono::milliseconds(bsm_generation_period_ms),
...
void BSMGenerator::initializeBSM()
{
  ...
  bsm_.core_data.size.presence_vector =
    bsm_.core_data.size.presence_vector | bsm_.core_data.size.VEHICLE_LENGTH_AVAILABLE;
  bsm_.core_data.size.presence_vector =
    bsm_.core_data.size.presence_vector | bsm_.core_data.size.VEHICLE_WIDTH_AVAILABLE;
}
...
void BSMGenerator::steerWheelAngleCallback(const std_msgs::msg::Float64::UniquePtr msg)
{
  ...
  bsm_.core_data.presence_vector =
    bsm_.core_data.presence_vector | bsm_.core_data.STEER_WHEEL_ANGLE_AVAILABLE;
}

void BSMGenerator::accelCallback(
  const automotive_platform_msgs::msg::VelocityAccelCov::UniquePtr msg)
{
  ...
  bsm_.core_data.accel_set.presence_vector =
    bsm_.core_data.accel_set.presence_vector | bsm_.core_data.accel_set.ACCELERATION_AVAILABLE;
}

void BSMGenerator::yawCallback(const sensor_msgs::msg::Imu::UniquePtr msg)
{
  bsm_.core_data.accel_set.yaw_rate =
    worker->getYawRateInRange(static_cast<float>(msg->angular_velocity.z));
  bsm_.core_data.accel_set.presence_vector =
    bsm_.core_data.accel_set.presence_vector | bsm_.core_data.accel_set.YAWRATE_AVAILABLE;
}

void BSMGenerator::brakeCallback(const std_msgs::msg::Float64::UniquePtr msg)
{
  bsm_.core_data.brakes.wheel_brakes.brake_applied_status =
...
void BSMGenerator::poseCallback(const geometry_msgs::msg::PoseStamped::UniquePtr msg)
{
  ...
  if (!map_projector_) {
    RCLCPP_DEBUG_STREAM(
      get_logger(), "Ignoring pose message as projection string has not been defined");
    return;
  }
  ...
  bsm_.core_data.presence_vector =
    bsm_.core_data.presence_vector | bsm_.core_data.LONGITUDE_AVAILABLE;
  bsm_.core_data.presence_vector =
    bsm_.core_data.presence_vector | bsm_.core_data.LATITUDE_AVAILABLE;
  bsm_.core_data.presence_vector =
    bsm_.core_data.presence_vector | bsm_.core_data.ELEVATION_AVAILABLE;
}
...
void BSMGenerator::headingCallback(const gps_msgs::msg::GPSFix::UniquePtr msg)
{
  ...
  bsm_.core_data.presence_vector =
    bsm_.core_data.presence_vector | bsm_.core_data.HEADING_AVAILABLE;
}
...
void BSMGenerator::generateBSM()
{
  ...
  bsm_.core_data.presence_vector =
    bsm_.core_data.presence_vector | bsm_.core_data.SEC_MARK_AVAILABLE;
  // currently the accuracy is not available because ndt_matching does not provide accuracy
  // measurement
