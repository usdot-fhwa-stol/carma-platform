 ...
 */
public class TransformMaintainerTest {
  ...
  public void setUp() throws Exception {
    log = LogFactory.getLog(TransformMaintainerTest.class);
    log.info("Setting up tests for TransformMaintainer");
  }
  ...
  public void testhandleOdometryMsg() throws Exception {
    ...
    envWkr = new TransformMaintainer(roadwayMgr, log, "earth", "map", "odom",
      "base_link", "pinpoint", "pinpoint");
    // Publish the transform from base_link to position sensor
