...
#include "carma_guidance_plugin/carma_guidance_plugin_node.hpp"


// TODO for USER: Implement a real test using GTest
TEST(Testcarma_guidance_plugin, example_test){

    rclcpp::NodeOptions options;
    auto worker_node = std::make_shared<carma_guidance_plugin::PluginBaseNode>(options);
