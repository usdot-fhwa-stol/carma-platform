...
double LCIStrategicPlugin::estimate_time_to_stop(double d, double v) const // TODO remove
{
  return 2.0 * d / v;
};
...
cav_msgs::Maneuver LCIStrategicPlugin::composeLaneFollowingManeuverMessage(double start_dist, double end_dist,
