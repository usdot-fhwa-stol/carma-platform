...
namespace approaching_emergency_vehicle_plugin
{
  ...
  private:
     ...
     * being tracked by this plugin. The generated message will follow the format described for the this plugin's APPROACHING_ERV_STATUS_PARAMS string object.
     * \return A carma_msgs::msg::UIInstructions message with a 'msg' string field that follows the format described for the this plugin's 
