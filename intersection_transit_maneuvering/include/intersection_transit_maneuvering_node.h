...
class IntersectionTransitManeuveringNode
{
    public:
        ...
        void run()
        {
            ...
            ros::ServiceClient trajectory_client = nh_.serviceClient<cav_srvs::PlanTrajectory>("plugins/inlanecruising_plugin/plan_trajectory");
            ...
            trajectory_srv_ = nh_.advertiseService("plugins/intersection_transit_maneuvering/plan_trajectory",&IntersectionTransitManeuvering::plan_trajectory_cb, &worker);           
