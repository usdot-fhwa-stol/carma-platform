...
public class HoldingStateTest {
    ...
    public void testOnMobilityOperationMessage() {
        ...
        final HoldingState holdingState = new HoldingState( mockRSUMeterWorker, mockLog, VEHICLE_ID, planId, vehLagTime, vehMaxAccel, distToMerge);
