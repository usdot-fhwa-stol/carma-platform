...
namespace waypoint_generator
{
    class WaypointGeneratorNode
    {
        ...
        private:
            ...
            double curvature_epsilon = 3.0;
            int linearity_constraint = 2;
            double lateral_accel_limit = 1.5;
            double longitudinal_accel_limit = 1.5;
            double longitudinal_decel_limit = 1.5;
            double max_speed = 35.0;
            autoware_msgs::LaneArray cur_waypoints;
