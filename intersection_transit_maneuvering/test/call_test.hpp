...
class CallTest: public CallInterface
{
    public:
         ...
         */
        void call(carma_planning_msgs::srv::PlanTrajectory::Request::SharedPtr req, carma_planning_msgs::srv::PlanTrajectory::Response& resp);
    ...
    private:
        ...
        carma_planning_msgs::srv::PlanTrajectory::Response response;
