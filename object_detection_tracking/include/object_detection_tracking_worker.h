...
public:
  ...
  using TransformLookupCallback =
    std::function<boost::optional<geometry_msgs::msg::TransformStamped>(
      const std::string &, const std::string &, const rclcpp::Time & stamp)>;
  ...
  \brief detectedObjectCallback populates detected object along with its velocity,yaw, yaw_rate and
  static/dynamic class to DetectedObject message. \param  msg array of detected objects.
  */
