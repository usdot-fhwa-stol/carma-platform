...
public abstract class NeighborBase implements INeighborCalculator {
    ...
    // protected final double                  DEFAULT_GREEN_DURATION = 37.5;  //sec was 27
    // protected final double                  DEFAULT_YELLOW_DURATION = 2.5;  //sec was 3
    // protected final double                  DEFAULT_RED_DURATION = 20.0;    //sec was 30
    ...
    protected final double                  DEFAULT_RED_DURATION = 3r0.0;    //sec was 30
