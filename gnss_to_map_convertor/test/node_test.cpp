...
TEST(GNSSToMapConvertor, geoReferenceCallback)
{
  gnss_to_map_convertor::GNSSToMapConvertor convertor(
      ...
      "map", "base_link", "ned_heading", NULL);
...
//   gps_msgs::msg::GPSFixConstPtr fix_ptr(new gps_msgs::msg::GPSFix(fix_msg));
...
//   fix_ptr = gps_msgs::msg::GPSFixConstPtr(new gps_msgs::msg::GPSFix(fix_msg));
