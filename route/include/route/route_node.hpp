 ...
 *      - Route generation which provides the list of available routes and provides vehicle travel
 route description and management.
...
private:
  ...
  // Service Servers
  carma_ros2_utils::ServicePtr<carma_planning_msgs::srv::GetAvailableRoutes>
