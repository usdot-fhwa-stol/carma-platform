...
{
  RCLCPP_ERROR_STREAM(rclcpp::get_logger("carma_mw_ctrl"),"Starting configuration!");
  ...
  RCLCPP_ERROR_STREAM(rclcpp::get_logger("carma_mw_ctrl"),"Done initializing worker!");
  ...
  RCLCPP_ERROR_STREAM(rclcpp::get_logger("carma_mw_ctrl"),"Done loading parameters: " << config_);
