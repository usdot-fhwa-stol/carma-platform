...
'''
This file is can be used to launch the CARMA light_controlled_intersection_tactical_plugin_node.
...
def generate_launch_description():
    ...
    container = ComposableNodeContainer(
        ...
        name='light_controlled_intersection_tactical_plugin_container',
