...
TEST(WMListenerWorkerTest, setConfigSpeedLimitTest)
{
  ...
  RCLCPP_ERROR_STREAM(rclcpp::get_logger("WMListenerWorkerTest"), "config_speed_limit = "<< current_cl);
}
...
TEST(WMListenerWorkerTest, getVehicleParticipationTypeTest)
{
  ...
  RCLCPP_ERROR_STREAM(rclcpp::get_logger("WMListenerWorkerTest"),"Participant = "<< current_pt);
}
