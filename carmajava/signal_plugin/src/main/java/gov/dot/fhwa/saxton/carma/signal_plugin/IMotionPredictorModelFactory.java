...
*/
public interface IMotionPredictorModelFactory {
  /**
  * Create a new instance of IMotionPredictor
  * 
  * @param desiredPredictorName A string identifying the motion prediction model which will be used
  * 
  * @throws IllegalArgumentException Exception thrown if the desired model could not be instantiated
  * 
