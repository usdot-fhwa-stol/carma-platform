...
'''
This file is can be used to launch the CARMA intersection_transit_maneuvering_node.
...
def generate_launch_description():
    ...
    param_file_path = os.path.join(
        get_package_share_directory('intersection_transit_maneuvering'), 'config/parameters.yaml')
