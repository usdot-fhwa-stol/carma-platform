...
namespace localizer
{
    ...
    LocalizationManager::LocalizationManager(PosePublisher pose_pub, TransformPublisher transform_pub, LocalizationManagerConfig config) :
        pose_pub_(pose_pub), transform_pub_(transform_pub), config_(config), counter_(config.score_upper_limit, config.unreliable_message_upper_limit)
    {}
