    ...
    :node_base_(node_base),node_logging_(node_logging),node_topics_(node_topics),worker_(std::unique_ptr<WMListenerWorker>(new WMListenerWorker)), multi_threaded_(multi_thread)
{
  ...
  rclcpp::Parameter is_voices_and_spat_wall_time_param("is_voices_and_spat_wall_time");
  if(!node_params_->get_parameter("is_voices_and_spat_wall_time", is_voices_and_spat_wall_time_param)){
    rclcpp::ParameterValue is_voices_and_spat_wall_time_param_value;
    is_voices_and_spat_wall_time_param_value = node_params_->declare_parameter("is_voices_and_spat_wall_time", rclcpp::ParameterValue (true));
  }
  ...
  is_voices_and_spat_wall_time_param = node_params_->get_parameter("is_voices_and_spat_wall_time");
  ...
  RCLCPP_INFO_STREAM(node_logging->get_logger(), "Is SPaT using wall time? : " << is_voices_and_spat_wall_time_param.as_bool());
  ...
  worker_->isSpatWallTime(is_voices_and_spat_wall_time_param.as_bool());
