...
Node::Node(const rclcpp::NodeOptions & options) : carma_guidance_plugins::TacticalPlugin(options)
{
...
carma_ros2_utils::CallbackReturn Node::on_configure_plugin()
{
  ...
  worker_ = std::make_shared<PlatooningTacticalPlugin>(
    get_world_model(), config_,
