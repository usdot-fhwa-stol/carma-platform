...
def generate_launch_description():
    ...
    declare_simulation_mode = DeclareLaunchArgument(name='simulation', default_value = 'False', descriptionn = 'True if CARMA Platform is launched with CARLA Simulator')
